namespace Skyline.DataMiner.MediaOps.Plan.Exceptions
{
    ...
    {
        /// <summary>
        /// Gets a list of IDs of items that were successfully processed.
        /// </summary>
        List<K> SuccessfulIds { get; }

        /// <summary>
        /// Gets a the <see cref="MediaOpsTraceData"/> per processed item.
        /// </summary>
        Dictionary<K, MediaOpsTraceData> TraceDataPerItem { get; }

        /// <summary>
        /// Gets a list of IDs of the items that could not get processed.
        /// </summary>
        List<K> UnsuccessfulIds { get; }
    }
}
