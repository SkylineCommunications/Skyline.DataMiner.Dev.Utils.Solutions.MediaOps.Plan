namespace Skyline.DataMiner.MediaOps.Plan.API
{
    ...
    /// <summary>
    /// Exception thrown when a resource with the specified identifier cannot be found.
    /// </summary>
    [Serializable]
    public class ResourceNotFoundException : Exception
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ResourceNotFoundException"/> class with a specified resource identifier.
        /// </summary>
        /// <param name="id">The unique identifier of the resource that was not found.</param>
