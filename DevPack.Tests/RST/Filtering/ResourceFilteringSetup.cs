namespace RT_MediaOps.Plan.RST.Filtering
{
	...
	internal sealed class ResourceFilteringSetup
	{
		...
		private void CreateCompleteResources()
		{
			...
			CompleteResource4 = objectCreator.CreateResource(CompleteResource4);
		...
		private void CreateElementResources()
		{
			...
			ElementResource1 = objectCreator.CreateResource(ElementResource1);
		}
		...
		private void CreateServiceResources()
		{
			...
			ServiceResource1 = objectCreator.CreateResource(ServiceResource1);
		}
		...
		private void CreateVirtualFunctionResources()
		{
			...
			VirtualFunctionResource1 = objectCreator.CreateResource(VirtualFunctionResource1);
		}
		...
		private void CreateConfigurations()
		{
			...
			Region = objectCreator.CreateConfiguration(Region);
			Distance = objectCreator.CreateConfiguration(Distance);
			ResolutionConfig = objectCreator.CreateConfiguration(ResolutionConfig);
			PriorityConfig = objectCreator.CreateConfiguration(PriorityConfig);
		}
