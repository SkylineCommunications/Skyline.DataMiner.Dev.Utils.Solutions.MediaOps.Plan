namespace RT_MediaOps.Plan.RST.Filtering
{
	...
	public sealed class ResourceStudioFilteringTests
	{
		...
		private Tuple<Resource[], FilterElement<Resource>>[] ResourceFilterTestCases => new[]
		{
			...
			new Tuple<Resource[], FilterElement<Resource>>([Setup.DraftResource1!, Setup.DraftResource2!], ResourceFilter.AND(ResourceExposers.VirtualSignalGroupInputId.Equal(Setup.VirtualSignalInputId))),
			new Tuple<Resource[], FilterElement<Resource>>([Setup.DraftResource1!, Setup.DraftResource2!], ResourceFilter.AND(ResourceExposers.VirtualSignalGroupOutputId.Equal(Setup.VirtualSignalOutputId))),

			new Tuple<Resource[], FilterElement<Resource>>([Setup.DraftResource3!, Setup.CompleteResource4!, Setup.CompleteResource5!, Setup.ServiceResource1!, Setup.VirtualFunctionResource1!, Setup.ElementResource1!], ResourceFilter.AND(ResourceExposers.VirtualSignalGroupInputId.NotEqual(Setup.VirtualSignalInputId))),
			new Tuple<Resource[], FilterElement<Resource>>([Setup.DraftResource3!, Setup.CompleteResource4!, Setup.CompleteResource5!, Setup.ServiceResource1!, Setup.VirtualFunctionResource1!, Setup.ElementResource1!], ResourceFilter.AND(ResourceExposers.VirtualSignalGroupOutputId.NotEqual(Setup.VirtualSignalOutputId))),
		};
