namespace RT_MediaOps.Plan.RST.Configurations
{
	...
	public sealed class HashCodeTests
	{
		...
		public void DiscreteNumberConfiguration_TrackableObject_DefaultValue()
		{
			...
			configuration.AddDiscrete(new Skyline.DataMiner.Solutions.MediaOps.Plan.API.NumberDiscrete(10, "Low"));
			configuration.AddDiscrete(new Skyline.DataMiner.Solutions.MediaOps.Plan.API.NumberDiscrete(20, "Medium"));
			configuration.DefaultValue = new Skyline.DataMiner.Solutions.MediaOps.Plan.API.NumberDiscrete(10, "Low");

			var initialHash = configuration.GetHashCode();

			configuration.DefaultValue = new Skyline.DataMiner.Solutions.MediaOps.Plan.API.NumberDiscrete(20, "Medium");
		...
		public void DiscreteTextConfiguration_TrackableObject_Name()
		{
			...
			configuration.AddDiscrete(new Skyline.DataMiner.Solutions.MediaOps.Plan.API.TextDiscrete("Low", "low_value"));
		...
		public void DiscreteTextConfiguration_TrackableObject_DefaultValue()
		{
			...
			configuration.AddDiscrete(new Skyline.DataMiner.Solutions.MediaOps.Plan.API.TextDiscrete("Low", "low_value"));
			configuration.AddDiscrete(new Skyline.DataMiner.Solutions.MediaOps.Plan.API.TextDiscrete("Medium", "medium_value"));
			configuration.DefaultValue = new Skyline.DataMiner.Solutions.MediaOps.Plan.API.TextDiscrete("Low", "low_value");

			var initialHash = configuration.GetHashCode();

			configuration.DefaultValue = new Skyline.DataMiner.Solutions.MediaOps.Plan.API.TextDiscrete("Medium", "medium_value");
