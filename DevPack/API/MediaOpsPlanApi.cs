namespace Skyline.DataMiner.Solutions.MediaOps.Plan.API
{
	...
	public class MediaOpsPlanApi : IMediaOpsPlanApi
	{
		...
		private readonly Lazy<IPropertySettingCollectionsRepository> lazyPropertyValueCollectionsRepository;
		...
		internal MediaOpsPlanApi(IConnection connection)
		{
			...
			lazyPropertyValueCollectionsRepository = new Lazy<IPropertySettingCollectionsRepository>(() => new PropertySettingCollectionsRepository(this));
		...
		/// <inheritdoc/>
		/// </summary>
		public IPropertySettingCollectionsRepository PropertyValueCollections => lazyPropertyValueCollectionsRepository.Value;
