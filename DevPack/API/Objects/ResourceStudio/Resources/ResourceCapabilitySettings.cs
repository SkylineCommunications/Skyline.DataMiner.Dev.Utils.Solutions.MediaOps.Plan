namespace Skyline.DataMiner.Solutions.MediaOps.Plan.API
{
    ...
    public class ResourceCapabilitySettings : TrackableObject
    {
        ...
        public ResourceCapabilitySettings AddDiscrete(string value)
        {
        ...
        /// <exception cref="ArgumentNullException">Thrown if <paramref name="value"/> is <see langword="null"/> or empty.</exception>
        public ResourceCapabilitySettings RemoveDiscrete(string value)
        {
            if (string.IsNullOrEmpty(value))
            {
                throw new ArgumentNullException(nameof(value));
        ...
        public ResourceCapabilitySettings SetDiscretes(ICollection<string> values)
        {
            if (values == null)
            {
