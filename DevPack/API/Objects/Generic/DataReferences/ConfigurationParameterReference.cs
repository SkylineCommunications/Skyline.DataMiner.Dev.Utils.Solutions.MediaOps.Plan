namespace Skyline.DataMiner.Solutions.MediaOps.Plan.API
{
    ...
    /// </summary>
    public sealed class ConfigurationParameterReference : DataReference
    {
        private const string ParameterIdKey = "ConfigurationParameterId";
        ...
        /// </param>
        public ConfigurationParameterReference(Guid parameterId, string nodeId = null) : base(DataReferenceType.ConfigurationParameter, nodeId)
        {
            ParameterId = parameterId;
        }

        /// <summary>
        /// Gets the unique identifier of the configuration parameter.
        /// </summary>
        ...
        public override bool Equals(DataReference other)
        {
            return base.Equals(other)
                && other is ConfigurationParameterReference ncpr
                && ncpr.ParameterId == ParameterId;
        }
        ...
        internal static ConfigurationParameterReference ParseFromStorage(Storage.DOM.DataReference reference, string nodeId)
        {
