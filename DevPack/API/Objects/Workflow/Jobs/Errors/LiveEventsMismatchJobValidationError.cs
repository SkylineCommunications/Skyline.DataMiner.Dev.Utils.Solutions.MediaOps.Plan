namespace Skyline.DataMiner.Solutions.MediaOps.Plan.API
{
	...
	public class LiveEventsMismatchJobValidationError : JobValidationError
	{
		...
		/// <summary>Initializes a new instance of the <see cref="LiveEventsMismatchJobValidationError"/> class.</summary>
		public LiveEventsMismatchJobValidationError(string message)
