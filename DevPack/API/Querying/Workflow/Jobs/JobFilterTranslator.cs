	...
	internal class JobFilterTranslator : DomInstanceFilterTranslator<Job>
	{
		...
		public JobFilterTranslator(MediaOpsPlanApi planApi)
		{
			...
			filterHandlers = new Dictionary<string, Func<Comparer, object, FilterElement<DomInstance>>>
			{
				...
				[JobExposers.Duration.fieldName] = (comparer, value) => FilterElementFactory.Create(DomInstanceExposers.FieldValues.DomInstanceField(SlcWorkflowIds.Sections.JobInfo.JobDuration), comparer, (TimeSpan)value),
				...
				[JobExposers.Resources.fieldName] = (comparer, value) => NodeReferenceFilterFactory.Create(SlcWorkflowIds.Enums.Nodetype.Resource, comparer, (Guid)value, JobExposers.Resources.fieldName),
				[JobExposers.ResourcePools.fieldName] = (comparer, value) => NodeReferenceFilterFactory.Create(SlcWorkflowIds.Enums.Nodetype.ResourcePool, comparer, (Guid)value, JobExposers.ResourcePools.fieldName),
			...
			orderByHandlers = new Dictionary<string, Func<SortOrder, bool, IOrderByElement>>
			{
				...
				[JobExposers.Duration.fieldName] = (sortOrder, naturalSort) => OrderByElementFactory.Create(DomInstanceExposers.FieldValues.DomInstanceField(SlcWorkflowIds.Sections.JobInfo.JobDuration), sortOrder, naturalSort),
