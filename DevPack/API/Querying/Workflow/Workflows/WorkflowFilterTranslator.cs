namespace Skyline.DataMiner.Solutions.MediaOps.Plan.API
{
	...
	internal class WorkflowFilterTranslator : DomInstanceFilterTranslator<Workflow>
	{
		...
		private readonly Dictionary<string, Func<Comparer, object, FilterElement<DomInstance>>> handlers = new Dictionary<string, Func<Comparer, object, FilterElement<DomInstance>>>
		{
			...
			[WorkflowExposers.Resources.fieldName] = (comparer, value) => NodeReferenceFilterFactory.Create(SlcWorkflowIds.Enums.Nodetype.Resource, comparer, (Guid)value, WorkflowExposers.Resources.fieldName),
			[WorkflowExposers.ResourcePools.fieldName] = (comparer, value) => NodeReferenceFilterFactory.Create(SlcWorkflowIds.Enums.Nodetype.ResourcePool, comparer, (Guid)value, WorkflowExposers.ResourcePools.fieldName),
		};
