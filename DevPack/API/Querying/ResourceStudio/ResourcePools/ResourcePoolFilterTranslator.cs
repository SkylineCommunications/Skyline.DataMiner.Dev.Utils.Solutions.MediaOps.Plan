namespace Skyline.DataMiner.Solutions.MediaOps.Plan.API
{
    ...
    internal class ResourcePoolPoolFilterTranslator : DomInstanceFilterTranslator<ResourcePool>
    {
        ...
        private readonly Dictionary<string, Func<Comparer, object, FilterElement<DomInstance>>> handlers = new Dictionary<string, Func<Comparer, object, FilterElement<DomInstance>>>
        {
            ...
            [ResourcePoolExposers.HasIconImage.fieldName] = (comparer, value) => FilterElementFactory.Create(DomInstanceExposers.FieldValues.KeyExists(SlcResource_StudioIds.Sections.ResourcePoolOther.IconImage.Id.ToString()), comparer, (bool)value),
            ...
            [ResourcePoolExposers.HasUrl.fieldName] = (comparer, value) => FilterElementFactory.Create(DomInstanceExposers.FieldValues.KeyExists(SlcResource_StudioIds.Sections.ResourcePoolOther.URL.Id.ToString()), comparer, (bool)value),
