namespace Skyline.DataMiner.Solutions.MediaOps.Plan.API
{
	...
	public sealed class JobValidationResult
	{
		...
		internal bool ClearResolvedErrorsFromUpdate()
		{
			...
			var changed = false;
			var clearableCodes = JobValidationError.MediaOpsOwnedErrorCodes.Where(code => code != TransitionToTentativeJobValidationError.ErrorCode).ToHashSet(StringComparer.Ordinal);
