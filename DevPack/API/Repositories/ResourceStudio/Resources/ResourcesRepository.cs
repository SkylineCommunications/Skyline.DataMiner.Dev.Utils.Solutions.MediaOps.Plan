namespace Skyline.DataMiner.Solutions.MediaOps.Plan.API
{
    ...
    internal class ResourcesRepository : Repository, IResourcesRepository
    {
        ...
        private void HandleMoveToCompleteAction(Resource resource)
        {
            ...
            {
                PlanApi.Logger.Information(this, "Resource {resource.Id} is already in Complete state. No action taken.", [resource.Id]);
                return;
            }
        ...
        private void HandleMoveToDeprecatedAction(Resource resource)
        {
            ...
            {
                PlanApi.Logger.Information(this, "Resource {resource.Id} is already in Deprecated state. No action taken.", [resource.Id]);
                return;
            }
