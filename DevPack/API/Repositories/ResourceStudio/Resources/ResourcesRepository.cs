namespace Skyline.DataMiner.Solutions.MediaOps.Plan.API
{
	...
	internal class ResourcesRepository : Repository, IResourcesRepository
	{
		...
		public Resource Create(Resource apiObject)
		{
			if (apiObject == null)
			{
		...
		/// <returns>A read-only collection containing the created resources.</returns>
		...
		public IReadOnlyCollection<Resource> Create(IEnumerable<Resource> apiObjects)
		{
			if (apiObjects == null)
			{
		...
		/// <returns>A read-only collection containing the created or updated resources.</returns>
		/// <exception cref="ArgumentNullException">Thrown when <paramref name="apiObjects"/> is <c>null</c>.</exception>
		...
		public IReadOnlyCollection<Resource> CreateOrUpdate(IEnumerable<Resource> apiObjects)
		{
			if (apiObjects == null)
			{
				throw new ArgumentNullException(nameof(apiObjects));
		...
		public EligibleResourcesResult GetEligibleResources(EligibleResourcesContext context)
		{
			if (context == null)
			{
			...
			{
				var result = CoreEligibleResourceHandler.GetEligibleResources(PlanApi, context);
		...
		public Resource Update(Resource apiObject)
		{
			if (apiObject == null)
			{
				throw new ArgumentNullException(nameof(apiObject));
		...
		/// <returns>A read-only collection containing the updated resources.</returns>
		/// <exception cref="ArgumentNullException">Thrown when <paramref name="apiObjects"/> is <c>null</c>.</exception>
		...
		public IReadOnlyCollection<Resource> Update(IEnumerable<Resource> apiObjects)
		{
			if (apiObjects == null)
			{
				throw new ArgumentNullException(nameof(apiObjects));
