namespace Skyline.DataMiner.Solutions.MediaOps.Plan.API
{
	...
	public interface IResourcesRepository : IRepository<Resource>
	{
		...
		IReadOnlyDictionary<ResourcePool, IReadOnlyCollection<Resource>> GetResourcesPerPool(IEnumerable<ResourcePool> resourcePools);
		...
		IReadOnlyDictionary<ResourcePool, IReadOnlyCollection<Resource>> GetResourcesPerPool(IEnumerable<ResourcePool> resourcePools, ResourceState state);
