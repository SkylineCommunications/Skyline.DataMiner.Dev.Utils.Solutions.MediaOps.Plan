namespace Skyline.DataMiner.Solutions.MediaOps.Plan.API
{
	...
	internal class CapacitiesRepository : Repository, ICapacitiesRepository
	{
		...
		/// <returns>The created capacity.</returns>
		...
		/// <returns>A read-only collection containing the created capacities.</returns>
		...
		/// <returns>A read-only collection containing the created or updated capacities.</returns>
		/// <exception cref="ArgumentNullException">Thrown when <paramref name="apiObjects"/> is <c>null</c>.</exception>
		...
		public IEnumerable<Capacity> Read(FilterElement<Capacity> filter)
		{
			...
			{
				var coreCapacities = PlanApi.CoreHelpers.ProfileProvider.GetCapacities(filterTranslator.TranslateFilter(filter));
		...
		/// <returns>A read-only collection containing the updated capacities.</returns>
		/// <exception cref="ArgumentNullException">Thrown when <paramref name="apiObjects"/> is <c>null</c>.</exception>
