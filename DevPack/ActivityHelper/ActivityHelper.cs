namespace Skyline.DataMiner.Solutions.MediaOps.Plan.ActivityHelper
{
	using System;
	...
	public static class ActivityHelper
	{
		...
		/// </summary>
		public static readonly string ApiSourceName = "Skyline.DataMiner.Solutions.MediaOps.Plan.API";
