...
// </auto-generated>
//------------------------------------------------------------------------------
namespace Skyline.DataMiner.Solutions.MediaOps.Plan.Storage.DOM.SlcProperties
{
	using System;
	...
	internal static class SlcPropertiesIds
	{
...
namespace Skyline.DataMiner.Solutions.MediaOps.Plan.Storage.DOM.SlcProperties
{
	...
	/// </summary>
	internal partial class PropertyInstance : DomInstanceBase
	{
		/// <summary>
	...
	/// </summary>
	internal partial class PropertyValuesInstance : DomInstanceBase
	{
		/// <summary>
...
namespace Skyline.DataMiner.Solutions.MediaOps.Plan.Storage.DOM.SlcProperties
{
	...
	internal partial class PropertyInfoSection : DomSectionBase
	{
		...
		/// <summary>
		/// Gets or sets the FileSizeLimit field of the DOM Instance.
		/// </summary>
		/// <remarks>
		/// When retrieving the value:
		/// <list type="bullet">
		...
		public Int64? FileSizeLimit
		{
			get
			{
				var wrapper = section.GetValue<Int64>(SlcPropertiesIds.Sections.PropertyInfo.FileSizeLimit);
				if (wrapper != null)
				{
					return (Int64?)wrapper.Value;
				}
			...
			set
			{
				if (value == null)
				{
					section.RemoveFieldValueById(SlcPropertiesIds.Sections.PropertyInfo.FileSizeLimit);
				}
				else
				{
					section.AddOrUpdateValue(SlcPropertiesIds.Sections.PropertyInfo.FileSizeLimit, (Int64)value);
				}
			}
		}

		/// <summary>
		/// Gets or sets the AllowMultipleFiles field of the DOM Instance.
		/// </summary>
		/// <remarks>
		/// When retrieving the value:
		/// <list type="bullet">
		...
		public Boolean? AllowMultipleFiles
		{
			get
			{
				var wrapper = section.GetValue<Boolean>(SlcPropertiesIds.Sections.PropertyInfo.AllowMultipleFiles);
				if (wrapper != null)
				{
					return (Boolean?)wrapper.Value;
				}
			...
			set
			{
				if (value == null)
				{
					section.RemoveFieldValueById(SlcPropertiesIds.Sections.PropertyInfo.AllowMultipleFiles);
				}
				else
				{
					section.AddOrUpdateValue(SlcPropertiesIds.Sections.PropertyInfo.AllowMultipleFiles, (Boolean)value);
				}
			}
		}
	...
	/// </summary>
	internal partial class PropertyValueSection : DomSectionBase
	{
		/// <summary>
	...
	/// </summary>
	internal partial class PropertyValueInfoSection : DomSectionBase
	{
		/// <summary>
	...
	/// </summary>
	internal partial class LayoutSection : DomSectionBase
	{
		/// <summary>
